...
axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(loc + '/dist/data/forbes.json').then(function (_ref) {
  ...
  var top100 = data.slice(0, 100); // Sum the Net Worth of the top 100 billionaires

  var total = top100.reduce(function (acc, person) {
    var worth = typeof person.realTimeWorth === 'undefined' ? person.worth : person.realTimeWorth;
    return acc + worth;
  }, 0);
  var response = {};
  ...
  var topWorth = typeof top[0].realTimeWorth === 'undefined' ? top[0].worth * 1000000 : top[0].realTimeWorth * 1000000;
  var topName = top[0].name;
  var gender2 = top[0].gender === 'M' ? 'he' : 'she';
  var gender1 = top[0].gender === 'M' ? 'his' : 'her'; // Iterate through and insert the richest person's name

  var nameElements = document.getElementsByClassName('name');
  var nameArray = Array.prototype.slice.call(nameElements);
  nameArray.map(function (el) {
  ...
  document.getElementById('submit-form').onclick = function (e) {
    e.preventDefault();
    var yearly = document.getElementById('yearly-income').value;
    if (yearly === '') return;
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(loc + '/dist/data/currency.json').then(function (_ref3) {
      ...
      var income = yearly / rate[0][1];
      var years = Math.round(1000000 / income);
      var yearsNetWorth = num.format(topWorth / income);
      var numyears = topWorth / (income * 365);
...
var compare = function compare(a, b) {
  var worthA = typeof a.realTimeWorth === 'undefined' ? a.worth : a.realTimeWorth;
  var worthB = typeof b.realTimeWorth === 'undefined' ? b.worth : b.realTimeWorth;
  if (worthA < worthB) return 1;
  if (worthA > worthB) return -1;
  return 0;
};
...
__webpack_require__(/*! /mnt/d/dev/forbes/src/js/app.js */"./src/js/app.js");
module.exports = __webpack_require__(/*! /mnt/d/dev/forbes/src/scss/app.scss */"./src/scss/app.scss");
